...
@st.cache_data
def load_roster():
    data_path = os.path.join(os.path.dirname(__file__), "roster_data.json")
...
<div style='text-align:center;color:#334155;font-size:0.75rem;margin-top:32px;padding-top:16px;border-top:1px solid #1e293b;'>
  Shift Roster App &nbsp;·&nbsp; Built with Streamlit &nbsp;·&nbsp; Data from 2015–2030
</div>
""", unsafe_allow_html=True)
